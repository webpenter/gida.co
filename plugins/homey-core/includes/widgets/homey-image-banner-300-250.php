...
class homey_Image_Banner_300_250 extends WP_Widget {
	...
	**/
	public function __construct() {
		...
		parent::__construct(
	 		'homey_image_banner_300_250', // Base ID
			esc_html__( 'Homey: Image Banner 300x250', 'homey' ), // Name
			array( 'description' => esc_html__( 'Add image banner 300x300 or 300x250', 'homey' ), ) // Args
		);
	...
	**/
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'banner_url' ) ); ?>"><?php esc_html_e('Image Banner URL:', 'homey'); ?></label>
        ...
        <p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'banner_link' ) ); ?>"><?php esc_html_e('Image Banner Link:', 'homey'); ?></label>
...
if ( ! function_exists( 'homey_Image_Banner_300_250_loader' ) ) {
    function homey_Image_Banner_300_250_loader (){
     register_widget( 'homey_Image_Banner_300_250' );
    }
     add_action( 'widgets_init', 'homey_Image_Banner_300_250_loader' );
}
